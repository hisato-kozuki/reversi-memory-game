...
let NUMBER = 64;
    ...
    document.write('<div style="background-color: rgb(224, 224, 224); position: relative;">'
        ...
        +'<li font-size: 24px;>このリバーシ記憶ゲームは、8×8マスに敷き詰められた白と黒の駒の配置を記憶するゲームです。</li>'
        +'<li font-size: 24px;>最初の画面で配置を覚える時間を選択してから、スタートボタンを押せばすぐにゲームが始まります。</li>'
        +'<li font-size: 24px;>配置を覚えた後はrespondボタンを押して回答して、checkyouranswerボタンで答え合わせしてください。</li></details>'
    ...
    document.write('<div style="position: absolute; top: 720px; display: flex; justify-content: center; width: fit-content;"><h1 class="button" id="b1" style="background-color: rgb(255, 224, 128); " onclick="respond()">Respond</h1>'
    +'<h1 class="button" id="b2" style="background-color: rgb(128, 224, 128); width: 600px;" onclick="marking()">Check your answer</h1>'
